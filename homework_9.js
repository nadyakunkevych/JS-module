...
//     div.innerText = "Welcome to Okten School!"
//     div.style.fontSize = "50px";
//     document.body.appendChild(div)
//
//     let secondDiv = div.cloneNode(true);
...
//     let block = document.createElement("blockElement");
...
//     {title: 'Frontend', monthDuration: 4}
// ];
// За допомогою скріпта для кожного елементу масиву зробити <div class='item'> ,  в якому буде <h1 class='heading'>  з title  елементу,
