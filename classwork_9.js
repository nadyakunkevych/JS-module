...
//     nameBlock.innerText = simpson.name;
//
//     let surnameBlock = document.createElement("div");
//     surnameBlock.innerText = simpson.surname
//
//     let ageBlock = document.createElement("div");
//     ageBlock.innerText = simpson.age;
//
//     let infoBlock = document.createElement("div");
//     infoBlock.innerText = simpson.info;
//
//     let img = document.createElement("img");
//     img.src = simpson.photo;
//
//
//     divBlock.appendChild(nameBlock);
//     divBlock.appendChild(surnameBlock);
//     divBlock.appendChild(ageBlock);
//     divBlock.appendChild(infoBlock);
...
//
    ...
    hourDiv.innerText = coursesArrayElement.hourDuration;
        ...
        for (const modulesElementElement of coursesArrayElement.modules) {
            let module = document.createElement("li");
            module.innerText = modulesElementElement;
            modulesElement.appendChild(module);

        }

       divContainer.append(titleDiv, monthDiv, hourDiv, modulesElement);
